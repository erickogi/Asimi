...
public class DBKeys {
    ...
    public static final String TABLE = "remainders_table";


    // Labels Table Columns names
    public static final String KEY_ROWID = "_id";
    public static final String KEY_ID = "id";
    public static final String KEY_REMAINDER_NAME = "remainder_name";
    ...
    public String REMAINDER_NAME;
    public String REMAINDER_DESCRIPTION;
    public String REMAINDER_PLACE_LATITUDE;
    public String REMAINDER_PLACE_LONGITUDE;
